...
class FragTestTransitionCompat21 {
    ...
    public static void addTransitionTargets(Object enterTransitionObject,
                                            ...
                                            final FragTestTransitionCompat21.ViewRetriever inFragment, final View nonExistentView,
                                            FragTestTransitionCompat21.EpicenterView epicenterView, final Map<String, String> nameOverrides,
    ...
    private static void setSharedElementEpicenter(Transition transition,
                                                  final FragTestTransitionCompat21.EpicenterView epicenterView) {
        if (transition != null) {
            transition.setEpicenterCallback(new Transition.EpicenterCallback() {
